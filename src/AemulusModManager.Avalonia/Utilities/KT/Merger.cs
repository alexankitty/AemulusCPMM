        ...
        public static void UpperAll(string modDir)
        {
            ...
            while (directoryStack.Count > 0)
            {
                ...
                if (Directory.Exists(currentDir))
                {
                    ...
                    {
                        string newName = Path.Combine(subdir.Parent!.FullName, subdir.Name.ToUpper());
                        if (newName != subdir.FullName)
                        {
                            string tempName = subdir.FullName + "_aemupper";
                            Directory.Move(subdir.FullName, tempName);
                    ...
                    foreach (FileInfo file in directoryInfo.GetFiles())
                    {
                        ...
                        {
                            string tempName = file.FullName + "_aemupper";
